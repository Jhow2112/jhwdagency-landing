...
export const CITIES: LandingPageData[] = [
  ...
  },
  {
    ...
    subheading:
      "We're based in Meridian and we build websites for Meridian businesses. Local, hands-on, and reasonably priced.",
    bodyEyebrow: "Serving Meridian",
    bodyHeading: "Your neighbor in web design.",
    bodyParagraphs: [
      "We live and work in Meridian, which means we can meet you in person, at your shop, at a coffee place near The Village, or wherever's easy. We build websites for Meridian businesses across every part of town, including [contractors](/websites-for-contractors/), [restaurants](/websites-for-restaurants/), and [cleaning services](/websites-for-cleaning-services/). Every site is designed, hosted, and supported by us, so you always know who to call.",
      "Meridian has grown from a quiet farming town into one of the fastest-growing cities in the country, and the local business landscape has changed with it. Long-time owners are competing for the same searches as new arrivals from Boise and out of state. The advantage goes to whoever's website is the easiest to use on a phone: clear hours, quick contact, photos that match the actual business. We keep things simple: one page or ten, every site we build for Meridian is structured around the questions a real customer asks, not the buzzwords a template assumes.",
    ],
  },
  {
    ...
    bodyParagraphs: [
      "Nampa has grown fast, and the businesses growing with it need websites that keep up. We build clean, fast sites for Nampa [contractors](/websites-for-contractors/), [cleaning services](/websites-for-cleaning-services/), and [counselors](/websites-for-counselors/) that show up in Google for searches like \"plumber Nampa\" or \"counselor near me,\" and that actually convert visitors into calls and bookings. We work with Nampa businesses across the city, from shops along 12th Avenue to service businesses serving the wider Canyon County area.",
      "Most Nampa customers reach a website through a phone screen, often while standing in a yard, a kitchen, or a parking lot. That changes how a site needs to work. Big tappable buttons, hours and address visible without scrolling, page loads measured in seconds rather than tens of seconds. We build with mobile-first design as the default, not as an afterthought. The same site has to look right on a desktop monitor at the office and on a five-year-old phone with a cracked screen. Get that part right and the rest of the site does its job.",
    ],
  },
  {
    ...
    bodyParagraphs: [
      "Eagle's customer base expects polish. A website that looks dated or loads slowly costs you the click. We build sites that match the quality of the businesses we work with (including [contractors](/websites-for-contractors/), [restaurants](/websites-for-restaurants/), and [counselors](/websites-for-counselors/)), whether that's a boutique downtown, a real estate practice, or a professional service firm. Every site is hand-built, hosted, and supported, so you get a real website without the agency price tag.",
      "Eagle's customer base is decisive about quality. A site that looks dated, loads slowly, or feels generic costs you the click before the visitor reads a single word. The same applies to professional services where the website is doing the verification work before the first call. We take time on the typography, photo selection, and color treatment so the site signals the same quality your business delivers. No template that looks like a hundred other Eagle businesses, no stock-photo model in a hard hat. Real photos and a thoughtful design read as legitimate from the first scroll.",
    ],
  },
  {
  ...
  },
  {
    ...
    bodyParagraphs: [
      "Kuna's small-town feel is part of what makes it great, but you still need a website that holds up against the bigger players nearby. We build clean, fast, professional sites for Kuna [contractors](/websites-for-contractors/), [cleaning services](/websites-for-cleaning-services/), and [restaurants](/websites-for-restaurants/), with proper local SEO so you show up when nearby customers search. Every site is designed, hosted, and supported by us personally, so you never get bounced between departments.",
...
export const INDUSTRIES: LandingPageData[] = [
  ...
  },
  {
    ...
    bodyParagraphs: [
      "When someone searches your restaurant, they want three things in under five seconds: are you open, what's on the menu, and how do I get there. Whether they're searching from [Boise](/web-design-boise/) or [Meridian](/web-design-meridian/), a slow site or a clunky PDF menu sends them straight to the next option. We build clean, fast restaurant sites with real, up-to-date menus, clear hours, photo galleries, easy phone-to-call buttons, and tight Google Maps integration, plus a Google Business Profile that's set up properly so you show up in local pack results.",
  ...
  },
  {
    ...
    bodyParagraphs: [
      "People reaching out to a counselor are often making a vulnerable decision. Whether they're searching from [Boise](/web-design-boise/) or [Eagle](/web-design-eagle/), your website needs to feel calm, professional, and human, not flashy or salesy. We build counselor sites with a warm tone, clear specialties and modalities, an honest \"about\" page, simple intake-friendly contact options, and privacy-conscious analytics. No tracking pixels you don't want, no third-party widgets that compromise client trust.",
  ...
  },
  {
    ...
    bodyParagraphs: [
      ...
      "Beyond the phone number, your website needs to broadcast what customers verify before they call: 24/7 emergency availability if you offer it, the cities you actually serve (not just \"Treasure Valley\" but Meridian, Eagle, Nampa, Caldwell, the names people actually search), and real photos of your trucks, your team, and your completed installations. Stock photos of models in hard hats actively hurt you.",
