    ...
    <>
      ...
      <main className="bg-[#f3efe6] min-h-screen pt-28 pb-20">
        <div className="max-w-3xl mx-auto px-6 sm:px-8">
          ...
          {/* Body */}
          <div className="space-y-8" style={{ fontFamily: "Inter, sans-serif", color: "#2f3b32", lineHeight: "1.75" }}>

            <section>
              <p className="text-base">
                These Terms of Service ("Terms") govern your use of the website{" "}
                <strong>{DOMAIN}</strong> and any web design, development, SEO, or related services provided by Aralo Studio ("we," "us," or "our"), a sole proprietorship based in Meridian, Idaho, operated by Jeremy Howard.
              </p>
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1f2a22] mb-3" style={{ fontFamily: "Inter, sans-serif" }}>2. Payment Terms</h2>
              <p className="text-base">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1f2a22] mb-3" style={{ fontFamily: "Inter, sans-serif" }}>3. Project Revisions</h2>
              <p className="text-base">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1f2a22] mb-3" style={{ fontFamily: "Inter, sans-serif" }}>4. Client Responsibilities</h2>
              <p className="text-base">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1f2a22] mb-3" style={{ fontFamily: "Inter, sans-serif" }}>5. Intellectual Property</h2>
              <p className="text-base">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1f2a22] mb-3" style={{ fontFamily: "Inter, sans-serif" }}>6. Hosting and Maintenance</h2>
              <p className="text-base">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1f2a22] mb-3" style={{ fontFamily: "Inter, sans-serif" }}>7. SEO and AEO Services</h2>
              <p className="text-base">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1f2a22] mb-3" style={{ fontFamily: "Inter, sans-serif" }}>8. Limitation of Liability</h2>
              <p className="text-base">
                To the fullest extent permitted by law, Aralo Studio shall not be liable for any indirect, incidental, special, or consequential damages arising from the use of our services or this website, including but not limited to lost profits, lost data, or business interruption.
              </p>
              <p className="text-base mt-4">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1f2a22] mb-3" style={{ fontFamily: "Inter, sans-serif" }}>9. Governing Law</h2>
              <p className="text-base">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1f2a22] mb-3" style={{ fontFamily: "Inter, sans-serif" }}>10. Changes to These Terms</h2>
              <p className="text-base">
            ...
            <section>
              <h2 className="text-xl font-bold text-[#1f2a22] mb-3" style={{ fontFamily: "Inter, sans-serif" }}>11. Contact</h2>
              <p className="text-base">
